...
function send_message(msg) {
  ...
  var hostserver = "../api.php?action=send_message";
...
function get_contacts() {
  ...
  var hostserver = "../api.php?action=get_contacts";
...
function get_discussions() {
  var httpRequest = new XMLHttpRequest();
  var hostserver = "../api.php?action=get_discussions";
  httpRequest.open("GET", hostserver);
  httpRequest.onload = () => {
...
function get_messages() {
  var httpRequest = new XMLHttpRequest();
  var hostserver = "../api.php?action=get_messages&discussion_id=" + discussionId;
  httpRequest.open("GET", hostserver);
  httpRequest.onload = () => {
...
function refresh() {
  var httpRequest = new XMLHttpRequest();
  var hostserver = "../api.php?action=refresh";
  if (discussionId) {
    hostserver += "&discussion_id=" + discussionId;
  }
  httpRequest.open("GET", hostserver);
